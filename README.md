...
*  Currently training with **Makatob IT Securities (Cybersecurity Cohort)**.
...
*  Linux (Kali Linux, basic system navigation & tools).
*  Networking Fundamentals (IP, SSH, SCP, troubleshooting).
...
A self-directed hands-on project series focused on:
...
* Built with robotics + IoT integration.
* Monitors soil moisture & automates watering.
